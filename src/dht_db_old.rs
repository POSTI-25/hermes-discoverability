...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("
Swarm setup complete. Ready for commands (GET <key>, PUT <key> <value>, GET_PROVIDERS <key>, PUT_PROVIDER <key>).");
...
fn handle_input_line(kademlia: &mut kad::Behaviour<SimpleSledStore>, line: String) {
